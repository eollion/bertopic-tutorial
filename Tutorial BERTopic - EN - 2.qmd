...
Topic model evaluation is an active domain of research that would be impossible to sum up in this tutorial. Instead we propose an overview of the methods that exist and how to quickly tell if your topic model can be used or need to be refined.
<br/>
