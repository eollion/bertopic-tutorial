...
topics_name = (topic_model.get_topic_info().set_index("Topic")["Representation"])
topics_per_class.loc[:,"Topic Representation"] = topics_name
...
| Topic | Words | Frequency | Class | Topic Representation |
|---:|:---|---:|:---|:---|
|       3 | social, annotations, multimedia, snapshot, proposed |           1 | True    | ['data', 'thesis', 'systems', 'model', 'propose', 'based', 'approach', 'proposed', 'network', 'time'] |

: Table X: **XXX** {tbl-colwidths="[10, 30, 10, 20, 30]" #tbl-reason-doc-cluster}
...
: Table X: **XXX** {tbl-colwidths="[10, 30, 10, 20, 30]" #tbl-reason-tags-cluster}
...
<br/>
To embed your documents, we use the [datasets](XXX) objects to bind the embeddings to the documents together: 
